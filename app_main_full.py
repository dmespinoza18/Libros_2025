...
# --- CONFIGURACIÓN CON HASHES ---
config = {
    "credentials": {
        "usernames": {
            "alumno1": {
                "name": "Alumno Uno",
                "password": "$pbkdf2-sha256$29000$BF7LwFYFZqUd3ZaqU5ZIMw$bmWeuR0wEjStEStEZHeAN0JuEo6HKNpBMw9FPyLwvA8"
            },
            "alumno2": {
                "name": "Alumno Dos",
                "password": "$pbkdf2-sha256$29000$OJ0meLPyzTZJzI9GMiFjvQ$d.wn1AqWmO3cKD0smLNmEoYGRMGq01ge5YfKAbW2AoY"
            }
        }
    },
    "cookie": {
        "name": "curso_python_app",
        "key": "abcdef",
        "expiry_days": 1
    }
}
